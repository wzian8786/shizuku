...
template class Port<IR_DEFAULT>;
template class IPort<IR_DEFAULT>;
template class PPort<IR_DEFAULT>;
template class Net<IR_DEFAULT>;
template class MInst<IR_DEFAULT>;
template class PInst<IR_DEFAULT>;
template class Module<IR_DEFAULT>;
template class Process<IR_DEFAULT>;
}
